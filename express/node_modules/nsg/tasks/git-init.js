...
const gitEnvironmentVariables = {
    GIT_AUTHOR_NAME: process.env.GIT_AUTHOR_NAME || 'nsg',
    GIT_AUTHOR_EMAIL: process.env.GIT_AUTHOR_EMAIL || 'nsg.cli@fe-artisan.com',
...
//# sourceMappingURL=d:/fe.artisan/nsg/tasks/git-init.js.map