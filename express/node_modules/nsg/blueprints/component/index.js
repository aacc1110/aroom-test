...
exports.default = Blueprint.extend({
    ...
    locals: function (options) {
        ...
        correctCase(options);
        let componentPath = this.dynamicPath.dir.replace(this.dynamicPath.sourceDir, '');
        if (!options.flat) {
            componentPath += path.sep + this.dynamicPath.base;
        }
...
//# sourceMappingURL=d:/fe.artisan/nsg/blueprints/component/index.js.map