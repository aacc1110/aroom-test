...
exports.getProdConfig = function (wco) {
    ...
    if (appConfig.serviceWorker) {
        ...
        and try again, or run \`nsg set apps.0.serviceWorker=false\` in your .angular-cli.json.
      `);
        }
...
//# sourceMappingURL=d:/fe.artisan/nsg/models/webpack-configs/production.js.map