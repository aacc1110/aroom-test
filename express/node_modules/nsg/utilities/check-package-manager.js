...
function checkYarnOrCNPM() {
    ...
    return Promise
        ...
        if (isYarnInstalled && isCNPMInstalled) {
            console.log(chalk.yellow('You can `nsg set --global packageManager=yarn` '
                + 'or `nsg set --global packageManager=cnpm`.'));
        }
        else if (isYarnInstalled) {
            console.log(chalk.yellow('You can `nsg set --global packageManager=yarn`.'));
        }
        else if (isCNPMInstalled) {
            console.log(chalk.yellow('You can `nsg set --global packageManager=cnpm`.'));
        }
    });
}
...
//# sourceMappingURL=d:/fe.artisan/nsg/utilities/check-package-manager.js.map