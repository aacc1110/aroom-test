...
exports.default = Command.extend({
    ...
    beforeRun: function (rawArgs) {
        ...
        if (!blueprint) {
            SilentError.debugOrThrow('nsg/cli/commands/generate', `Invalid blueprint: ${name}`);
        }
        if (!rawArgs[1]) {
            SilentError.debugOrThrow('nsg/cli/commands/generate', `The \`nsg generate ${name}\` command requires a name to be specified.`);
        }
    ...
    run: function (commandOptions, rawArgs) {
        ...
        if (!name) {
          ...
          The "nsg generate" command requires a
...
//# sourceMappingURL=d:/fe.artisan/nsg/commands/generate.js.map