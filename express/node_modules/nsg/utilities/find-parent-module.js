...
function findParentModule(projectRoot, appRoot, currentDir) {
    const sourceRoot = path.join(projectRoot, appRoot, 'ns');
    // trim currentDir
    currentDir = currentDir.replace(path.join(appRoot, 'ns'), '');
...
//# sourceMappingURL=d:/fe.artisan/nsg/utilities/find-parent-module.js.map