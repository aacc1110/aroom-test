...
module.exports = Command.extend({
  ...
  run: function(commandOptions, rawArgs) {
    ...
    if (!blueprintName) {
      return Promise.reject(new SilentError('The `nsg generate` command requires a ' +
  ...
  addAdditionalJsonForHelp: function(json, options) {
    json.availableBlueprints = this.getAllBlueprints(options).filter(x => x.name !== 'nsg');
  },
