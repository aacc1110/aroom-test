...
const NewCommand = Command.extend({
    name: 'new',
    description: `Creates a new directory and a new Angular app eg. "nsg new [name]".`,
    ...
    availableOptions: [
        ...
        },
        {
            ...
            default: false,
            aliases: ['lc'],
            description: 'Automatically link the `nsg` package.',
            hidden: true
        },
        {
            name: 'skip-install',
        ...
        // },
        {
            ...
            type: String,
            default: 'css',
            description: 'Currently only css is supported.'
        },
        {
            name: 'prefix',
            type: String,
    ...
    run: function (commandOptions, rawArgs) {
        ...
        if (!packageName) {
            return Promise.reject(new SilentError(`The "nsg ${this.name}" command requires a name argument to be specified eg. ` +
                chalk.yellow('nsg new [name] ') +
                `For more details, use "nsg help".`));
        }
        if (commandOptions.style && commandOptions.style !== 'css') {
            return Promise.reject(new SilentError(chalk.yellow('Currently only `--style css` is supported.')));
        }
        validate_project_name_1.validateProjectName(packageName);
        commandOptions.name = packageName;
        commandOptions.sourceDir = 'app';
        commandOptions.tests = false;
        commandOptions.style = 'css';
...
//# sourceMappingURL=d:/fe.artisan/nsg/commands/new.js.map